          ...
          <div>
            {assignments.length > 0 ? (
              assignments.map((assignment, index) => (
                <div
                  key={index}
                  className="p-4 flex justify-between bg-blue-100 border border-blue-300 rounded-lg shadow hover:bg-blue-200 transition mb-2"
                > {index + 1}: {" - "}
                <strong>  {assignment.assignment || "No Topic Name"}  </strong>
                  
                  {'( assignment ID : '+ assignment.assignmentId || "No Topic Name"} {")"}
