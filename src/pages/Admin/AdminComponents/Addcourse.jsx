  ...
  return (
    <div className=" h-screen overflow-y-scroll p-2">
        ...
        <div className="bg-white border-t-4 border-navbarColor shadow-lg rounded-lg relative overflow-x-auto sm:rounded-lg">
          <div className="flex items-center justify-start flex-column flex-wrap md:flex-row md:space-y-0 bg-white dark:bg-gray-900">
          {/* <h2 className="text-lg md:text-2xl font-serif text-center text-headingColor mb-4 border-b pb-2 border-blue-500">
                 Courses {Courses.length}
              </h2> */}
            <div className="text-lg md:text-2xl font-serif text-center text-headingColor shadow rounded  p-4 m-2">
